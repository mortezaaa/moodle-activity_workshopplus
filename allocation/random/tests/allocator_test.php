...
class workshopplusallocation_random_testcase extends basic_testcase {
    ...
    protected function setUp() {
        ...
        $workshopplus           = (object)array('id' => 42);
        $this->workshopplus     = new workshopplus($workshopplus, $cm, $course, $context);
        $this->allocator    = new testable_workshopplus_random_allocator($this->workshopplus);
    }
