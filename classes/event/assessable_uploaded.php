...
/**
 * mod_workshopplus assessable uploaded event.
 *
...
/**
 * mod_workshopplus assessable uploaded event class.
 *
 * @package    mod_workshopplus
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    protected function get_legacy_eventdata() {
        ...
        $eventdata->modulename   = 'workshopplus';
    ...
    public static function get_name() {
        return get_string('event_assessable_uploaded', 'mod_workshopplus');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/workshopplus/submission.php',
    ...
    protected function init() {
        parent::init();
        $this->data['objecttable'] = 'workshopplus_submissions';
    }
