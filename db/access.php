...
/**
 * Capability definitions for the workshopplus module
 *
...
$capabilities = array(
    ...
    // Ability to see that the workshopplus exists, and the basic information
    ...
    // Ability to add a new workshopplus to the course.
    ...
    // Ability to change the current phase (stage) of the workshopplus, for example
    // allow submitting, start assessment period, close workshopplus etc.
    ...
    // in the workshopplus as the authors
    ...
    // Ability to publish submissions, i.e. make them available when workshopplus is closed
    ...
    // Ability to view published submission when the workshopplus is closed. Group mode
