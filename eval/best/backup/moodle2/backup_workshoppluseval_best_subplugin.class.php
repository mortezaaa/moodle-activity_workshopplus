 ...
 * strictness factor. It adds its XML data to workshopplus tag.
 */
class backup_workshoppluseval_best_subplugin extends backup_subplugin {

    /**
     * Returns the subplugin information to attach to workshopplus element
     */
    protected function define_workshopplus_subplugin_structure() {
        ...
        $subplugin_table_settings = new backup_nested_element('workshoppluseval_best_settings', null, array('comparison'));
        ...
        $subplugin_table_settings->set_source_table('workshoppluseval_best_settings', array('workshopplusid' => backup::VAR_ACTIVITYID));
