...
require_once($CFG->dirroot . '/mod/workshopplus/eval/best/lib.php');
require_once($CFG->libdir . '/gradelib.php');


class workshoppluseval_best_evaluation_testcase extends basic_testcase {
    ...
    protected function setUp() {
        ...
        $workshopplus       = (object)array('id' => 42, 'evaluation' => 'best');
        $this->workshopplus = new workshopplus($workshopplus, $cm, $course, $context);
        $this->evaluator = new testable_workshopplus_best_evaluation($this->workshopplus);
    }
    ...
    public function test_assessments_distance_zero_variance() {
        ...
        // Simulate structure returned by {@link workshopplus_best_evaluation::prepare_data_from_recordset()}
        $assessments = array(
        ...
        // Process assessments in the same way as in the {@link workshopplus_best_evaluation::process_assessments()}
 ...
 */
class testable_workshopplus_best_evaluation extends workshopplus_best_evaluation {
