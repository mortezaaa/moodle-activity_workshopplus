 ...
 */
abstract class workshopplus_evaluation {

    /**
     * Calculates grades for assessment and updates 'gradinggrade' fields in 'workshopplus_assessments' table
     *
     ...
     *
     * @return workshopplus_evaluation_settings_form
     */
    public function get_settings_form(moodle_url $actionurl=null) {

        $customdata = array('workshopplus' => $this->workshopplus);
        $attributes = array('class' => 'evalsettingsform');

        return new workshopplus_evaluation_settings_form($actionurl, $customdata, 'post', '', $attributes);
    }
 ...
 */
class workshopplus_evaluation_settings_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('submit', 'submit', get_string('aggregategrades', 'workshopplus'));
    }
