 ...
 * @uses moodleform
 */
class workshopplus_accumulative_assessment_form extends workshopplus_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'workshopplusform_accumulative', $i+1);
            ...
            $label = get_string('dimensiongrade', 'workshopplusform_accumulative');
            ...
            $mform->addRule(array('grade__idx_' . $i, 'minusone') , get_string('mustchoosegrade', 'workshopplusform_accumulative'), 'compare', 'gt');

            // comment
            $label = get_string('dimensioncomment', 'workshopplusform_accumulative');
