 ...
 * needed to restore one workshopplusform_accumulative subplugin.
 */
class restore_workshopplusform_accumulative_subplugin extends restore_subplugin {
    ...
    protected function define_workshopplus_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_accumulative_dimension'); // we used get_recommended_name() so this works
    ...
    protected function define_referenceassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_accumulative_referencegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_exampleassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_accumulative_examplegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_assessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_accumulative_grade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    /**
     * Processes the workshopplusform_accumulative_dimension element
     */
    public function process_workshopplusform_accumulative_dimension($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('workshopplusform_accumulative', $data);
        $this->set_mapping($this->get_namefor('dimension'), $oldid, $newitemid, true);

        // Process files for this workshopplusform_accumulative->id only
        $this->add_related_files('workshopplusform_accumulative', 'description', $this->get_namefor('dimension'), null, $oldid);
    }

    /**
     * Processes the workshopplusform_accumulative_referencegrade element
     */
    public function process_workshopplusform_accumulative_referencegrade($data) {
        $this->process_dimension_grades_structure('workshopplus_referenceassessment', $data);
    }

    /**
     * Processes the workshopplusform_accumulative_examplegrade element
     */
    public function process_workshopplusform_accumulative_examplegrade($data) {
        $this->process_dimension_grades_structure('workshopplus_exampleassessment', $data);
    }

    /**
     * Processes the workshopplusform_accumulative_grade element
     */
    public function process_workshopplusform_accumulative_grade($data) {
