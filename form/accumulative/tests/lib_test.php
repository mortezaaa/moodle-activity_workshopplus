...
require_once($CFG->dirroot . '/mod/workshopplus/form/accumulative/lib.php');


class workshopplus_accumulative_strategy_testcase extends advanced_testcase {
    /** workshopplus instance emulation */
    protected $workshopplus;

    /** @var testable_workshopplus_accumulative_strategy instance of the strategy logic class being tested */
    protected $strategy;
    ...
    protected function setUp() {
        ...
        $workshopplus       = (object)array('id' => 42, 'strategy' => 'accumulative');
        $this->workshopplus = new workshopplus($workshopplus, $cm, $course, $context);
        $this->strategy = new testable_workshopplus_accumulative_strategy($this->workshopplus);
    }
 ...
 */
class testable_workshopplus_accumulative_strategy extends workshopplus_accumulative_strategy {
