 ...
 * @uses moodleform
 */
class workshopplus_assessment_form extends moodleform {
    ...
    public function definition() {
        ...
        $this->workshopplus = $this->_customdata['workshopplus'];   // instance of the workshopplus api class
        ...
        if ($this->workshopplus->overallfeedbackmode and $this->is_editable()) {
            ...
            $mform->addElement('editor', 'feedbackauthor_editor', get_string('feedbackauthor', 'mod_workshopplus'), null,
                $this->workshopplus->overall_feedback_content_options());
            ...
            if ($this->workshopplus->overallfeedbackfiles) {
                $mform->addElement('filemanager', 'feedbackauthorattachment_filemanager',
                    ...
                    $this->workshopplus->overall_feedback_attachment_options());
            }
        }
        ...
        if (!empty($this->options['editableweight']) and $this->is_editable()) {
            ...
            $mform->addElement('select', 'weight',
                    get_string('assessmentweight', 'workshopplus'), workshopplus::available_assessment_weights_list());
