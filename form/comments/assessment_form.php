 ...
 * @uses moodleform
 */
class workshopplus_comments_assessment_form extends workshopplus_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'workshopplusform_comments', $i+1);
            ...
            // comment
            $label = get_string('dimensioncomment', 'workshopplusform_comments');
