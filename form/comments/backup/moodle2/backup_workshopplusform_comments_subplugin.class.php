 ...
 */
class backup_workshopplusform_comments_subplugin extends backup_subplugin {
    ...
    protected function define_workshopplus_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('workshopplusform_comments_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('workshopplusform_comments', array('workshopplusid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('workshopplusform_comments', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_comments_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_comments_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_comments_grade');
    }
