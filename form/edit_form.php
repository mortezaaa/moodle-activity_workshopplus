 ...
 * @uses moodleform
 */
class workshopplus_edit_strategy_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('hidden', 'workshopplusid', $this->workshopplus->id);        // workshopplusid
        $mform->setType('workshopplusid', PARAM_INT);

        $mform->addElement('hidden', 'strategy', $this->workshopplus->strategy);    // strategy name
        ...
        $buttonarray[] = $mform->createElement('submit', 'saveandpreview', get_string('saveandpreview', 'workshopplus'));
