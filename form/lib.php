 ...
 */
interface workshopplus_strategy {
     ...
     * are saved in workshopplusform_{strategyname} tables.
     *
     ...
     * If workshopplusid is null, it checks for any workshopplus instance. If workshopplusid is provided,
