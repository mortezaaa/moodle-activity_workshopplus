 ...
 * @uses moodleform
 */
class workshopplus_numerrors_assessment_form extends workshopplus_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'workshopplusform_numerrors', $i+1);
            ...
            $label = get_string('dimensiongrade', 'workshopplusform_numerrors');
            ...
            ), 'group_grade__idx_' . $i, get_string('yourassessment', 'workshopplus'), '<br />', false);
            $mform->addRule('group_grade__idx_' . $i, get_string('required'), 'required');

            // comment
            $label = get_string('dimensioncomment', 'workshopplusform_numerrors');
