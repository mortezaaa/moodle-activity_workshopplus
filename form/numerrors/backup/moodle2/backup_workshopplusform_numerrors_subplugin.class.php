 ...
 */
class backup_workshopplusform_numerrors_subplugin extends backup_subplugin {
    ...
    protected function define_workshopplus_subplugin_structure() {
        ...
        $subpluginmap = new backup_nested_element('workshopplusform_numerrors_map', array('id'), array(
            'nonegative', 'grade'));
        $subplugindimension = new backup_nested_element('workshopplusform_numerrors_dimension', array('id'), array(
        ...
        $subpluginmap->set_source_table('workshopplusform_numerrors_map', array('workshopplusid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('workshopplusform_numerrors', array('workshopplusid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('workshopplusform_numerrors', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_numerrors_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_numerrors_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_numerrors_grade');
    }
