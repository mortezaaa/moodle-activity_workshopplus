 ...
 * needed to restore one workshopplusform_numerrors subplugin.
 */
class restore_workshopplusform_numerrors_subplugin extends restore_subplugin {
    ...
    protected function define_workshopplus_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_numerrors_map'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);

        $elename = $this->get_namefor('dimension');
        $elepath = $this->get_pathfor('/workshopplusform_numerrors_dimension'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_referenceassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_numerrors_referencegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_exampleassessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_numerrors_examplegrade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    protected function define_assessment_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/workshopplusform_numerrors_grade'); // we used get_recommended_name() so this works
        $paths[] = new restore_path_element($elename, $elepath);
    ...
    /**
     * Processes the workshopplusform_numerrors_map element
     */
    public function process_workshopplusform_numerrors_map($data) {
        global $DB;

        $data = (object)$data;
        $data->workshopplusid = $this->get_new_parentid('workshopplus');
        $DB->insert_record('workshopplusform_numerrors_map', $data);
    }

    /**
     * Processes the workshopplusform_numerrors_dimension element
     */
    public function process_workshopplusform_numerrors_dimension($data) {
        global $DB;
        ...
        $newitemid = $DB->insert_record('workshopplusform_numerrors', $data);
        $this->set_mapping($this->get_namefor('dimension'), $oldid, $newitemid, true);

        // Process files for this workshopplusform_numerrors->id only
        $this->add_related_files('workshopplusform_numerrors', 'description', $this->get_namefor('dimension'), null, $oldid);
    }

    /**
     * Processes the workshopplusform_numerrors_referencegrade element
     */
    public function process_workshopplusform_numerrors_referencegrade($data) {
        $this->process_dimension_grades_structure('workshopplus_referenceassessment', $data);
    }

    /**
     * Processes the workshopplusform_numerrors_examplegrade element
     */
    public function process_workshopplusform_numerrors_examplegrade($data) {
        $this->process_dimension_grades_structure('workshopplus_exampleassessment', $data);
    }

    /**
     * Processes the workshopplusform_numerrors_grade element
     */
    public function process_workshopplusform_numerrors_grade($data) {
