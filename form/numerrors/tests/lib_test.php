...
require_once($CFG->dirroot . '/mod/workshopplus/form/numerrors/lib.php');


class workshopplusform_numerrors_strategy_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $workshopplus       = (object)array('id' => 42, 'strategy' => 'numerrors');
        $this->workshopplus = new workshopplus($workshopplus, $cm, $course, $context);
        $this->strategy = new testable_workshopplus_numerrors_strategy($this->workshopplus);
    }
 ...
 */
class testable_workshopplus_numerrors_strategy extends workshopplus_numerrors_strategy {
