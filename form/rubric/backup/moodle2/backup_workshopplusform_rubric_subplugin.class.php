 ...
 */
class backup_workshopplusform_rubric_subplugin extends backup_subplugin {

    /**
     * Returns the assessment form definition to attach to 'workshopplus' XML element
     */
    protected function define_workshopplus_subplugin_structure() {
        ...
        $subpluginconfig = new backup_nested_element('workshopplusform_rubric_config', null, 'layout');
        $subplugindimension = new backup_nested_element('workshopplusform_rubric_dimension', array('id'), array(
            'sort', 'description', 'descriptionformat'));
        $subpluginlevel = new backup_nested_element('workshopplusform_rubric_level', array('id'), array(
        ...
        $subpluginconfig->set_source_table('workshopplusform_rubric_config', array('workshopplusid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('workshopplusform_rubric', array('workshopplusid' => backup::VAR_ACTIVITYID));
        $subpluginlevel->set_source_table('workshopplusform_rubric_levels', array('dimensionid' => backup::VAR_PARENTID));

        // file annotations
        $subplugindimension->annotate_files('workshopplusform_rubric', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_rubric_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_rubric_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('workshopplusform_rubric_grade');
    }
