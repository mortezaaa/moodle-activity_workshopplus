...
require_once($CFG->dirroot . '/mod/workshopplus/form/rubric/lib.php');


class workshopplusform_rubric_strategy_test extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $workshopplus       = (object)array('id' => 42, 'strategy' => 'rubric');
        $this->workshopplus = new workshopplus($workshopplus, $cm, $course, $context);
        $this->strategy = new testable_workshopplus_rubric_strategy($this->workshopplus);
 ...
 */
class testable_workshopplus_rubric_strategy extends workshopplus_rubric_strategy {
