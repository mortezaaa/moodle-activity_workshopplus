...
/**
 * Strings for component 'workshopplus', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    mod
...
$string['configexamplesmode'] = 'Default mode of examples assessment in workshoppluss';
$string['configgrade'] = 'Default maximum grade for submission in workshoppluss';
$string['configgradedecimals'] = 'Default number of digits that should be shown after the decimal point when displaying grades.';
$string['configgradinggrade'] = 'Default maximum grade for assessment in workshoppluss';
$string['configmaxbytes'] = 'Default maximum submission file size for all workshoppluss on the site (subject to course limits and other local settings)';
$string['configstrategy'] = 'Default grading strategy for workshoppluss';
...
$string['gradegivento'] = '&gt;';
$string['gradeitemassessment'] = '{$a->workshopplusname} (assessment)';
$string['gradeitemsubmission'] = '{$a->workshopplusname} (submission)';
$string['gradeover'] = 'Override grade for submission';
$string['gradesreport'] = 'workshopplus grades report';
...
$string['groupnoallowed'] = 'You are not allowed to access any group in this workshopplus';
...
$string['modulename'] = 'workshopplus';
$string['modulename_help'] = 'The workshopplus activity module enables the collection, review and peer assessment of students\' work.
...
Students obtain two grades in a workshopplus activity - a grade for their submission and a grade for their assessment of their peers\' submissions. Both grades are recorded in the gradebook.';
$string['modulename_link'] = 'mod/workshopplus/view';
$string['modulenameplural'] = 'workshoppluss';
$string['mysubmission'] = 'My submission';
$string['nattachments'] = 'Maximum number of submission attachments';
$string['noexamples'] = 'No examples yet in this workshopplus';
...
$string['nosubmissions'] = 'No submissions yet in this workshopplus';
$string['nothingtoreview'] = 'Nothing to review';
$string['notassessed'] = 'Not assessed yet';
$string['notoverridden'] = 'Not overriden';
$string['noworkshoppluss'] = 'There are no workshoppluss in this course';
...
$string['page-mod-workshopplus-x'] = 'Any workshopplus module page';
...
$string['pluginadministration'] = 'workshopplus administration';
$string['pluginname'] = 'workshopplus';
...
$string['publishsubmission_help'] = 'Published submissions are available to the others when the workshopplus is closed.';
$string['reassess'] = 'Re-assess';
$string['receivedgrades'] = 'Grades received';
$string['recentassessments'] = 'workshopplus assessments:';
$string['recentsubmissions'] = 'workshopplus submissions:';
...
$string['strategyhaschanged'] = 'The workshopplus grading strategy has changed since the form was opened for editing.';
...
$string['submissionendswitch_help'] = 'If the submissions deadline is specified and this box is checked, the workshopplus will automatically switch to the assessment phase after the submissions deadline.

If you enable this feature, it is recommended to set up the scheduled allocation method, too. If the submissions are not allocated, no assessment can be done even if the workshopplus itself is in the assessment phase.';
...
$string['subplugintype_workshopplusallocation'] = 'Submissions allocation method';
$string['subplugintype_workshopplusallocation_plural'] = 'Submissions allocation methods';
$string['subplugintype_workshoppluseval'] = 'Grading evaluation method';
$string['subplugintype_workshoppluseval_plural'] = 'Grading evaluation methods';
$string['subplugintype_workshopplusform'] = 'Grading strategy';
$string['subplugintype_workshopplusform_plural'] = 'Grading strategies';
$string['switchingphase'] = 'Switching phase';
$string['switchphase'] = 'Switch phase';
$string['switchphase10info'] = 'You are about to switch the workshopplus into the <strong>Setup phase</strong>. In this phase, users cannot modify their submissions or their assessments. Teachers may use this phase to change workshopplus settings, modify the grading strategy or tweak assessment forms.';
$string['switchphase20info'] = 'You are about to switch the workshopplus into the <strong>Submission phase</strong>. Students may submit their work during this phase (within the submission access control dates, if set). Teachers may allocate submissions for peer review.';
$string['switchphase30auto'] = 'workshopplus will automatically switch into the assessment phase after {$a->daydatetime} ({$a->distanceday})';
$string['switchphase30info'] = 'You are about to switch the workshopplus into the <strong>Assessment phase</strong>. In this phase, reviewers may assess the submissions they have been allocated (within the assessment access control dates, if set).';
$string['switchphase40info'] = 'You are about to switch the workshopplus into the <strong>Grading evaluation phase</strong>. In this phase, users cannot modify their submissions or their assessments. Teachers may use the grading evaluation tools to calculate final grades and provide feedback for reviewers.';
$string['switchphase50info'] = 'You are about to close the workshopplus. This will result in the calculated grades appearing in the gradebook. Students may view their submissions and their submission assessments.';
...
$string['taskintro'] = 'Set the workshopplus description';
$string['tasksubmit'] = 'Submit your work';
$string['toolbox'] = 'workshopplus toolbox';
$string['undersetup'] = 'The workshopplus is currently being set up. Please wait until it is switched to the next phase.';
...
$string['userplan'] = 'workshopplus planner';
$string['userplan_help'] = 'The workshopplus planner displays all phases of the activity and lists the tasks for each phase. The current phase is highlighted and task completion is indicated with a tick.';
...
$string['workshopplus:addinstance'] = 'Add a new workshopplus';
$string['workshopplus:allocate'] = 'Allocate submissions for review';
$string['workshopplus:editdimensions'] = 'Edit assessment forms';
$string['workshopplus:ignoredeadlines'] = 'Ignore time restrictions';
$string['workshopplus:manageexamples'] = 'Manage example submissions';
$string['workshopplusname'] = 'workshopplus name';
$string['workshopplus:overridegrades'] = 'Override calculated grades';
$string['workshopplus:peerassess'] = 'Peer assess';
$string['workshopplus:publishsubmissions'] = 'Publish submissions';
$string['workshopplus:submit'] = 'Submit';
$string['workshopplus:switchphase'] = 'Switch phase';
$string['workshopplus:view'] = 'View workshopplus';
$string['workshopplus:viewallassessments'] = 'View all assessments';
$string['workshopplus:viewallsubmissions'] = 'View all submissions';
$string['workshopplus:viewauthornames'] = 'View author names';
$string['workshopplus:viewauthorpublished'] = 'View authors of published submissions';
$string['workshopplus:viewpublishedsubmissions'] = 'View published submissions';
$string['workshopplus:viewreviewernames'] = 'View reviewer names';
$string['workshopplusviewed'] = 'workshopplus viewed';
