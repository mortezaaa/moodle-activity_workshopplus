...
/**
 * Unit tests for workshopplus api class defined in mod/workshopplus/locallib.php
 *
...
global $CFG;
require_once($CFG->dirroot . '/mod/workshopplus/locallib.php'); // Include the code to test


/**
 * Test cases for the internal workshopplus api
 */
class mod_workshopplus_internal_api_testcase extends advanced_testcase {

    /** workshopplus instance emulation */
    ...
    protected function setUp() {
        ...
        $this->workshopplus = new testable_workshopplus();
    }
    ...
    public function test_aggregate_submission_grades_process_notgraded() {
        ...
        // exercise SUT
        $this->workshopplus->aggregate_submission_grades_process($batch);
    }
    ...
    public function test_aggregate_grading_grades_process_nograding() {
        ...
        //$DB->expectNever('update_record');
        // excersise SUT
        $this->workshopplus->aggregate_grading_grades_process($batch);
    }
    ...
    public function test_aggregate_grading_grades_process_single_grade_new() {
        ...
        $expected->workshopplusid = $this->workshopplus->id;
        $expected->userid = 3;
        $expected->gradinggrade = 82.87670;
        $expected->timegraded = $now;
        //$DB->expectOnce('insert_record', array('workshopplus_aggregations', $expected));
        // excersise SUT
        $this->workshopplus->aggregate_grading_grades_process($batch, $now);
    }
    ...
    public function test_percent_to_value() {
        ...
        $percent = 56.6543;
        // exercise SUT
        $part = workshopplus::percent_to_value($percent, $total);
        // verify
    ...
    public function test_lcm() {
        ...
        $this->assertEquals(workshopplus::lcm(1,4), 4);
        $this->assertEquals(workshopplus::lcm(2,4), 4);
        $this->assertEquals(workshopplus::lcm(4,2), 4);
        $this->assertEquals(workshopplus::lcm(2,3), 6);
        $this->assertEquals(workshopplus::lcm(6,4), 12);
    }
    ...
    public function test_lcm_array() {
        ...
        // excersise SUT
        $lcm = array_reduce($numbers, 'workshopplus::lcm', 1);
        // verify
    ...
    public function test_prepare_example_assessment() {
        ...
        // excersise SUT
        $a = $this->workshopplus->prepare_example_assessment($fakerawrecord);
        // verify
        $this->assertTrue($a instanceof workshopplus_example_assessment);
    ...
    public function test_prepare_example_reference_assessment() {
        ...
        // excersise SUT
        $a = $this->workshopplus->prepare_example_reference_assessment($fakerawrecord);
        // verify
        $this->assertTrue($a instanceof workshopplus_example_reference_assessment);
 ...
 */
class testable_workshopplus extends workshopplus {
